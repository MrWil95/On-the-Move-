      ...
      <div className='Container' >
        {getAllPosts.map((generalPost, index) => (
          <div className='postscontainer' key={index}>
            {currentUser && currentUser.id === generalPost.user_id ? (<button onClick={() => handlePostDelete(generalPost.id)} className='deletebutton'><FaTimes /></button>) : (<></>)}
            ...
            <div className='buttoncontainer'>
              ...
              {currentUser && currentUser.id === generalPost.user_id ? (<Link to={`/edit/${generalPost.id}`}>
